...
async def process_gift_request(message: types.Message):
    ...
    instructions = (
        ...
        "2️⃣ 🔍 <b>Напишите в поиск</b>: <code>Новогодние подарки в телеграмм</code> или <code>Дед Мороз дарит подарки</code>\n"
...
async def admin_stats(callback: types.CallbackQuery):
    ...
    keyboard.button(text="📈 Детальная статистика", callback_data="admin_detailed_stats")
...
async def admin_users(callback: types.CallbackQuery):
    ...
    keyboard = InlineKeyboardBuilder()
    keyboard.button(text="📋 Экспорт списка", callback_data="export_users")
    keyboard.button(text="🔍 Найти ребёнка", callback_data="search_user")
    keyboard.button(text="🎅 В мастерскую", callback_data="admin_menu")
    keyboard.adjust(2)
...
async def admin_requests(callback: types.CallbackQuery):
    ...
    keyboard = InlineKeyboardBuilder()
    keyboard.button(text="✅ Исполнить желание", callback_data="mark_completed")
    keyboard.button(text="📋 Все желания", callback_data="all_requests")
    keyboard.button(text="🎅 В мастерскую", callback_data="admin_menu")
    keyboard.adjust(2)
